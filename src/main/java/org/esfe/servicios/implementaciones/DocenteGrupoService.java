...
public class DocenteGrupoService implements IDocenteGrupoService {
    ...
    @Override
    public Page<DocenteGrupo> buscarTodosPaginado(Pageable pageable) {
    ...
    @Override
    public DocenteGrupo crearOEditar(DocenteGrupo docenteGrupos) {
        return docenteGrupoRepository.save(docenteGrupos);
    }
